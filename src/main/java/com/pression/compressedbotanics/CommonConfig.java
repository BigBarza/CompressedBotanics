...
public class CommonConfig {
    ...
    static {
        ...
        COCOON_HATCH_TIME = BUILDER.comment("How many ticks does the cocoon of caprice take to hatch. Default is 2400 or 2 minutes")
                .defineInRange("Cocoon Hatch Time", 2400, 1, Integer.MAX_VALUE);
