...
public class ThrownPebbleEntity extends ThrowableItemProjectile {
    ...
    public ThrownPebbleEntity(EntityType<? extends ThrowableItemProjectile> entityType, Level level) {
    ...
    protected void onHitEntity(@NotNull EntityHitResult hit){
        ...
        if(entity instanceof LivingEntity living){
            ...
            living.hurt(this.damageSources().thrown(this, this.getOwner()), (float) Math.random());
        }
        this.discard();
    }
